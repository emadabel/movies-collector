...
public class MainActivity extends AppCompatActivity implements
        ...
        LoaderManager.LoaderCallbacks<MovieResultsPage> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoaderManager.LoaderCallbacks<MovieResultsPage> callback = MainActivity.this;
    ...
    private void loadMovieData(String query) {
        ...
        Loader<MovieResultsPage> moviesSearchLoader = loaderManager.getLoader(MOVIES_LOADER_ID);
    ...
    @Override
    public Loader<MovieResultsPage> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<MovieResultsPage>(this) {

            MovieResultsPage mMoviesData = null;
            ...
            public MovieResultsPage loadInBackground() {
                ...
                return search.searchMovie(query, null, "en", false, 1);
            }

            @Override
            public void deliverResult(MovieResultsPage moviesData) {
    ...
    @Override
    public void onLoadFinished(Loader<MovieResultsPage> loader, MovieResultsPage moviesData) {
        ...
        if (moviesData == null) {
            ...
            showMovieDataView();
            mMovieDbAdapter.setMovieData(moviesData.getResults());
        }
    }
